            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="numero_celular" class="col-md-4 col-form-label text-md-right">{{ __('Número de celular') }}</label>

                            <div class="col-md-6">
                                <input id="numero_celular" type="text" class="form-control @error('numero_celular') is-invalid @enderror" name="numero_celular" value="{{ old('numero_celular') }}" required autocomplete="numero_celular">
